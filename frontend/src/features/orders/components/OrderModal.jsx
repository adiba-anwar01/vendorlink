...
import { inputField, btnSecondary, btnPrimary } from '@/utils/theme';
...
export default function OrderModal({ item, onConfirm, onClose }) {
  ...
  const [prevItemId, setPrevItemId] = useState(currentItemId);
  ...
  return createPortal(
    ...
    >
      <div className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl">
        <div className="flex items-center justify-between border-b border-gray-100 bg-gradient-to-r from-brand-500/10 to-white px-6 py-4">
        ...
        <div className="space-y-5 p-6">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className={`${inputField} ${errors.buyerName ? 'border-red-400 focus:ring-red-200' : ''}`}
            />
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className={`${inputField} ${errors.phoneNumber ? 'border-red-400 focus:ring-red-200' : ''}`}
            />
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className={`${inputField} resize-none ${errors.deliveryAddress ? 'border-red-400 focus:ring-red-200' : ''}`}
            />
          ...
          <div className="flex gap-3 pt-1">
            <button onClick={onClose} className={`${btnSecondary} flex-1`} disabled={placing}>
              Cancel
            </button>
            <button
              onClick={handleConfirm}
              disabled={placing}
              className={`${btnPrimary} flex flex-1 items-center justify-center gap-2`}
            >
