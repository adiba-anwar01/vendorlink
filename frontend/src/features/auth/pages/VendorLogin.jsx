      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-0.5">Sign in to VendorLink</p>
          </div>
        </div>

        <form
          onSubmit={handleLogin}
          className="bg-white rounded-2xl border border-gray-100 shadow-[0_4px_24px_rgba(0,0,0,0.06)] p-8 space-y-5"
        >
