    ...
    <div className="space-y-8">
      ...
      <div className="relative h-64 sm:h-80 rounded-2xl overflow-hidden shadow-lg">
        {heroSlides.map((slide, index) => (
          <div
            key={index}
            className={`absolute inset-0 hero-slide transition-opacity duration-500 ease-in-out ${
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-8">
              ...
              <button
                onClick={() => navigate(`/explore-items?category=${slide.badge}`)}
            ...
            {filterCategories.map((cat) => (
              <button
                ...
                onClick={() => {
                  ...
                  if (cat !== 'All') {
                    navigate(`/explore-items?category=${cat}`);
                  } else {
